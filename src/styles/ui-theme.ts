const myTheme = {
  ...
  alert: {
    ...
    type: {
      primary: 'bg-primary-100 text-primary-900 border border-primary-300 dark:bg-primary-600 dark:text-white',
      secondary: 'bg-secondary-100 text-secondary-900 border border-secondary-300 dark:bg-secondary-600 dark:text-white',
      success: 'bg-success-100 text-neutral-800 border border-success-300 dark:bg-success-700 dark:text-white',
      error: 'bg-error-100 text-neutral-800 border border-error-300 dark:bg-error-700 dark:text-white',
      warning: 'bg-warning-100 text-neutral-800 border border-warning-300 dark:bg-warning-700 dark:text-white',
      neutral: 'bg-neutral-100 text-neutral-800 border border-neutral-300 dark:bg-neutral-700 dark:text-neutral-300',
    ...
    close: {
      base: 'h-5 w-5',
      primary: 'text-primary-400 hover:text-primary-700 dark:text-primary-300 dark:hover:text-primary-100',
      seconday: 'text-secondary-400 hover:text-secondary-700 dark:text-secondary-300 dark:hover:text-secondary-100',
      success: 'text-success-500 hover:text-success-700 dark:text-success-300 dark:hover:text-success-100',
      error: 'text-error-500 hover:text-error-700 dark:text-error-300 dark:hover:text-error-100',
      warning: 'text-warning-500 hover:text-warning-700 dark:text-warning-300 dark:hover:text-warning-100',
      neutral: 'text-neutral-500 hover:text-neutral-700 dark:text-neutral-300 dark:hover:text-neutral-100',
